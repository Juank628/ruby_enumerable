...
# 📖 [Ruby Enumarable] <a name="about-project"></a>

**Ruby Enumerable** it is a console application that contain Ruby enumarable methods
...
- **Replicate Ruby enumerable methods**
...
```sh
  cd my-folder
  git clone git@github.com:Juank628/ruby_enumerable.git
``` 
...
Feel free to check the [issues page](https://github.com/Juank628/ruby_enumerable/issues).
